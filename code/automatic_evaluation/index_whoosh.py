...
# usage      
# python index_whoosh.py sentences.txt index_dir
...
def main():
    index_dir = str(sys.argv[2]).strip()
    idx = create_index(index_dir=index_dir)
    writer = idx.writer(limitmb=2048, procs=10, multisegment=True)
